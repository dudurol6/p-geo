<?php 
    ...
    define('title', 'PG - Odległość');
    include('includes/header.php');

?>

<script type="text/javascript" src="scripts/odleglosc.js"></script>

<main>

	<div class="sep-line"></div>
    <div class="main-welcome-text">Kalkulator Odległość</div>
    ...
    <div class="main-box">
        ...
        <div class="box main-elem column bg border">
            ...
            <!----------------------------------------------------->
            <script>const appType = 'distanceHistory';</script>
            <?php include('includes/calculation-history.php'); ?>
            <!----------------------------------------------------->
            <div class="main-elem row"> <!-- 1 -->

                <div class="in-elem description-image" id="distance"></div>
                ...
                <div class="in-elem column"> <!-- 2 -->
                    ...
                    <input type="submit" name="submit" value="Oblicz" class="calc-form-submit-button" onclick="distance()">
                    <div id="result"></div>
